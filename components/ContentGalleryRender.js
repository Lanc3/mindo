...
export default function ContentGalleryRender({ htmlData, newHeight }) {
  ...
  <style> img { display: block; width: 170%; height: auto;  margin-left: -90px;
...
`
  ...
  return (
    <View
      style={{ height: theHeight, paddingHorizontal: 0, width: 'auto' }}
      scrollEnabled={false}
