...
const CatherineReillyScreen = ({ navigation }) => {
  ...
  const [title, setTitle] = useState('Catherine Reilly')
  const [authorID, setAuthorID] = useState(3248)
          ...
          <FlatList
            ...
            ListHeaderComponent={
              <Header
                ...
                data={sliderData}
                ImageURL={
                  'https://www.medicalindependent.ie/wp-content/uploads/2022/02/catherine-reily-medical-independent.jpg'
                }
              ></Header>
            }
            ListFooterComponent={
